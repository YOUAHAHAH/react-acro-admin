  ...
  const list: list[] = [
    {
      key: "1",
      label: "重新加载",
      icon: <IconRefresh className="mr-[5px]" />,
      onClick: () => window.location.reload()
    },
    {
      key: "2",
      label: "关闭当前标签页",
      icon: <IconClose className="mr-[5px]" />,
    ...
    },
    {
      key: "3",
      label: "关闭左侧标签页",
      icon: <IconToLeft className="mr-[5px]" />,
    ...
    },
    {
      key: "4",
      label: "关闭右侧标签页",
      icon: <IconToRight className="mr-[5px]" />,
            ...
            {list.map((item: list) => {
              return (
                <div key={item.key}>
                  ...
                  <Divider
                    className={
                      item.divider ? "block !my-[4px]" : "hidden !my-[4px]"
                    }
                  />
                </div>
              );
